...
class listingAssignmentTableClass extends listingAssignmentBaseTableClass {
   ...
   * @throws PDOException
   */
  public static function isListingAssigned($listing_id, $usuario_id) {
    try {
      $sql = 'SELECT ' . listingAssignmentTableClass::getNameField(listingAssignmentTableClass::ID) . ', '
              . listingAssignmentTableClass::getNameField(listingAssignmentTableClass::STATUS) .' AS listing_status '
              ...
              . ' AND ' . listingAssignmentTableClass::getNameField(listingAssignmentTableClass::USUARIO_ID) . ' = :user_id'
              . ' AND ' . listingAssignmentTableClass::getNameField(listingAssignmentTableClass::STATUS) . ' = :status';
      $params = array(
          ':id' => $listing_id,
          ':user_id'=> $usuario_id,
          ':status' => 1
   ...
   * @throws PDOException
   */
  public static function getIdListingAssignedByListingId($listing_id, $user_id) {
    try {
