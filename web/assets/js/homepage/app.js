...
if (window.location.pathname === '/') {
	(0, _jquery2.default)('.socials.mobile').find('a#signup').parent().next().hide();
}

(0, _jquery2.default)('.video-overlay').click(function () {
	var vo = (0, _jquery2.default)(this);
	var v = vo.prev('.video')[0];
	var f = vo.find('.fa');
	v.play();
	vo.hide();
});

(0, _jquery2.default)('.video').click(function () {
	var v = (0, _jquery2.default)(this)[0];
	var vo = (0, _jquery2.default)(this).next('.video-overlay');
	var f = vo.find('.fa');
...
(0, _jquery2.default)('.search-dropdown').click(function () {
	var f = (0, _jquery2.default)(this).find('.fa');
	(0, _jquery2.default)(f).toggleClass(function () {
		return f.is('.fa-chevron-up, .fa-chevron-down') ? 'fa-chevron-up fa-chevron-down' : 'fa-chevron-up';
	});
});

(0, _jquery2.default)('#search .dropdown-pane :checkbox').click(function () {
	var l = (0, _jquery2.default)(this).parent();
	l.toggleClass('on');
});

(0, _jquery2.default)('#neighborhoods #boroughs-list :checkbox').click(function () {
	var b = (0, _jquery2.default)(this).prev().html().toLowerCase();
	if (b != 'any') {
		(0, _jquery2.default)('.neighborhoods-list').find('#' + b).toggle();
	}
});

(0, _jquery2.default)('#search .green-button').click(function () {
	(0, _jquery2.default)('#search #neighborhoods').each(function (index, value) {
		(0, _jquery2.default)('input[type=checkbox]').each(function () {
			this.checked = false;
		});

		(0, _jquery2.default)('.borough').hide();
		(0, _jquery2.default)('li.on').toggleClass('on');
	});
});

(0, _jquery2.default)('#search .clear').click(function (e) {
	(0, _jquery2.default)(this).prev().val('');
	e.preventDefault();
});

(0, _jquery2.default)('#search .options').click(function (e) {
	var t = (0, _jquery2.default)(this).text();
	if (t.indexOf('MORE') > -1) {
		return (0, _jquery2.default)(this).html('<i class="fa fa-minus" aria-hidden="true"></i>LESS OPTIONS');
	} else {
		return (0, _jquery2.default)(this).html('<i class="fa fa-plus" aria-hidden="true"></i>MORE OPTIONS');
	}
	e.preventDefault();
});

(0, _jquery2.default)('.toggle-section').click(function (e) {
	var t = (0, _jquery2.default)(this);
	var f = t.find('.fa');
	var s = t.data('section');
	(0, _jquery2.default)(t).toggleClass(function () {
		return t.is('.active, .inactive') ? 'active inactive' : 'active';
	});
	(0, _jquery2.default)(f).toggleClass(function () {
		return f.is('.fa-chevron-up, .fa-chevron-down') ? 'fa-chevron-up fa-chevron-down' : 'fa-chevron-up';
	});
	(0, _jquery2.default)('#' + s).toggleClass(function () {
		return (0, _jquery2.default)('#' + s).is('.mobile, .desktop') ? 'mobile desktop' : 'mobile';
	});
	e.preventDefault();
});

(0, _jquery2.default)('#neighborhood-navigation').click(function () {
	(0, _jquery2.default)('#neighborhood-menu').toggle();
	(0, _jquery2.default)("#neighborhood-navigation").toggle();
});

(0, _jquery2.default)('#neighborhood-navigation-close').click(function (e) {
	(0, _jquery2.default)('#neighborhood-menu').toggle();
	(0, _jquery2.default)("#neighborhood-navigation").toggle();
	e.preventDefault();
});

(0, _jquery2.default)('#archive button.more-blog').click(function () {
	var b = (0, _jquery2.default)(this);
	var t = b.text().toLowerCase();
	if (t.indexOf('more') > -1) {
		t = t.replace(/more/i, 'less');
		t = t + '<i class="fa fa-chevron-up" aria-hidden="true"></i>';
	} else {
		t = t.replace(/less/i, 'more');
		t = t + '<i class="fa fa-chevron-down" aria-hidden="true"></i>';
	}
	setTimeout(function () {
		b.html(t);
	}, 100);
