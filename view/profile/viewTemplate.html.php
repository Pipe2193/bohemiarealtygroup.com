...
$profile_thumbnail = profileTableClass::THUMBNAIL_PICTURE;
$profile_big_picture = profileTableClass::BIG_PICTURE;
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-user-circle" aria-hidden="true"></i> View Profile <?php echo $objProfileInfo[0]->$profileFistName; ?> <?php echo $objProfileInfo[0]->$profileMiddleName; ?> <?php echo $objProfileInfo[0]->$profileLastName; ?> </h2>
                            ...
                            <div class="x_content">
                                <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                    <div class="row text-center">
                                        <div id="crop-avatar">
                                            <!-- Current avatar -->
                                            <img class="avatar-view" src="<?php echo routing::getInstance()->getUrlImg('cust_files/profile/agents/'. $objProfileInfo[0]->$profile_thumbnail) ?>" alt="Avatar" title="Change the avatar">
                                        </div>
                                    </div><br>
                                    <div class="row text-center">
