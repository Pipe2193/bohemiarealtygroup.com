            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                   ...
                   ?>
                    ...
                    <li><a><i class="fa fa-bar-chart" aria-hidden="true"></i> PERSONAL <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("splits", "index"); ?>">Splits Manager</a></li>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("deal", "index"); ?>">My Deals</a></li>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("deal", "add"); ?>">New Deals</a></li>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("dealsheet", "index"); ?>">DealSheets</a></li>
                    ...
                    <li><a><i class="fa fa-map-marker" aria-hidden="true"></i> VACANCIES <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("listing", "search"); ?>">Manage Listings</a></li>
                            ...
                            if (session::getInstance()->getFlash("sale_building_manage")) {
                              ?>
                              <li class="active"><a href="<?php echo routing::getInstance()->getUrlWeb("sales_building", "manage"); ?>">Manage Sales Building</a></li>
                              <?php
                            }

                            if (session::getInstance()->getFlash("sale_listing_manage")) {
                              ?>
                              <li class="active"><a href="<?php echo routing::getInstance()->getUrlWeb("sales_listing", "manage"); ?>">Manage Sales Listing</a></li>
                              <?php
                            }
                            ...
                            ?>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("lockbox", "index"); ?>"> Update Lockbox</a></li>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("syndication_log", "index"); ?>">Syndication Log</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav child_menu">
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("app_landlord", "index"); ?>"> Landlords </a></li>
                            <?php
                            if (session::getInstance()->getFlash("app_info_landlord_manage")) {
                              ?>
                              <li><a href="<?php echo routing::getInstance()->getUrlWeb("app_landlord", "manage"); ?>">Manage App & Info - Landlord</a></li>
                              <?php
                            }
                            ?>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("app_landlord", "general"); ?>">General</a></li>
                        </ul>  
                    </li>
                    <li><a><i class="fa fa-money" aria-hidden="true"></i> BBUCKS <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="#">Add BBucks</a></li>
                            <li><a href="#">Transfer BBucks</a></li>
                            <li><a href="#">Reverse Transfer</a></li>
                            <li><a href="#">Add Cash In Items</a></li>
                            <li><a href="#">List Cash In Items</a></li>
                            <li><a href="#">Ask for a Favor</a></li>
                            <li><a href="#">Manage Favors</a></li>
                            <li><a href="#">Latest Favors</a></li>
                            <li><a href="#">Cash In Items</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav child_menu">
                            ...
                            ?>
                            <li><a href="<?php echo routing::getInstance()->getUrlWeb("credencial", "index") ?>">User Roles  Permissions</a></li>
                            <?php
                ...
                <ul class="nav side-menu">
                    <li>
                        ...
                        <ul class="nav child_menu">
                            ...
                            <li><a href="https://bohemiarealtygroup.com/guest-registration" target="_blank"> CCF</a></li>
                        </ul>
