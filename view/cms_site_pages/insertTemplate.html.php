                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="page-title-bohemia ">
                                    <h3><i class="fa fa-file-text-o" aria-hidden="true"></i> New Post </h3>
                                </div>

                                <div class="panel panel-success">
                                    <div class="panel-body">
                                        <div class="btn-group   pull-left">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb("cms_blogs", "index"); ?>" class="btn btn-default" type="button"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form id="addBlogPost" class=" form-horizontal form-label-left" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb("cms_blogs", "create"); ?>" >
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb("cms_blogs", "index"); ?>" type="button" class="btn btn-danger "><i class="fa fa-times-circle-o" aria-hidden="true"></i> Cancel</a>
