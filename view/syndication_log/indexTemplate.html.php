                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            ...
                            <div class=" hidden-xs x_title">
                                <h2><i class="fa fa-server" aria-hidden="true"></i> Sync Log </h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="page-title-bohemia visible-xs">
                                    <h4 class="text-center"><i class="fa fa-server" aria-hidden="true"></i> Sync Log</h4>
                                </div>
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#rental_sync"> <i class="fa fa-building-o" aria-hidden="true"></i> <b>RENTALS SYNC LOG</b></a></li>
                                    <li><a data-toggle="tab" href="#sales_sync"><b>SALES SYNC LOG</b></a></li>
                                    
                                </ul>

                                <div class="tab-content">
                                    <div id="rental_sync" class="tab-pane fade in active">
                                        </br>
