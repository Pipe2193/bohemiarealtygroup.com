                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapse3" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <div class="alert alertbrg alert-dismissible" role="alert">
                                                    <p>
                                                        <i class="fa fa-info-circle" aria-hidden="true"></i> Information: Listings with Label color <span class="label label-info">Color</span>    are syncing from Nestio.<br>
                                                    </p>
                                                    <p>
                                                        <i class="fa fa-info-circle" aria-hidden="true"></i> Information: Listings with Label color <span class="label" style="background-color: #ffd6d5;"> Color</span>   are Open with Listing Agent.<br>
                                                    </p>
                                                </div>
                                                <div class="panel panel-success">
                                                    <div class="panel-body">
                                        ...
                                        <div id="collapse5" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="btn-group  btn-group-sm pull-right">
                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <button  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" type="button"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Add Document</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <?php if (empty($objFiles)) { ?>
                                                  ...
                                                  <div class="alert alert-info alert-dismissible" role="alert">
                                                      <p class="text-center">
                                                          <b> <i class="fa fa-info-circle" aria-hidden="true"></i> Information: There are no Documents found. </b> <a href="<?php echo routing::getInstance()->getUrlWeb("file", "ajax", array(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true) => mvc\request\requestClass::getInstance()->getGet(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true)))) ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--dark" type="button"><i class="fa fa-plus-square-o" aria-hidden="true"></i> <b>Add Document</b></a><br>
                                                      </p>
                                                  </div>
                                                  <?php
                                                }
