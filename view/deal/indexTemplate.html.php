                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            ...
                            <div class=" hidden-xs x_title">
                                <h2><i class="fa fa-server" aria-hidden="true"></i> Deals </h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="page-title-bohemia visible-xs">
                                    <h4 class="text-center"><i class="fa fa-server" aria-hidden="true"></i> Deals</h4>
                                </div>
                                ...
                                <div class="tab-content">
                                    <div id="rental_deals_panel" class="tab-pane fade in active">
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body">
                                                <div class=" pull-right">
                                                    <a href="<?php echo routing::getInstance()->getUrlWeb("deal", "add"); ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> <b>Export</b></a>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body">
                                                <form action="<?php echo routing::getInstance()->getUrlWeb("deal", "index") ?>" method="GET" >
                                                    <div class="form-row">
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                                <label class="control-label col-md-2 col-sm-2 col-xs-12"> Beds</label>
                                                                <select id="<?php echo listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE, true) ?>" name="<?php echo listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE, true) ?>" class="form-control" >
                                                                    <option value="">Select Option </option>  
                                                                    <?php foreach ($objListingSize as $size): ?>
                                                                      <?php if (\mvc\request\requestClass::getInstance()->getGet(listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE, true)) == $size->$listing_size_id) { ?>
                                                                        <option value="<?php echo \mvc\request\requestClass::getInstance()->getGet(listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE, true)); ?>" selected> SELECTED: <?php echo $size->$listing_size_description; ?></option>
                                                                      <?php } else { ?>
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                                ...
                                                                <select id="<?php echo listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE, true) ?>_to" name="<?php echo listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE, true) ?>_to" class="form-control" >
                                                                    <option value="">Select Option </option>  
                                                                    <?php foreach ($objListingSize as $size): ?>
                                                                      <?php if (\mvc\request\requestClass::getInstance()->getGet(listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE . '_to', true)) == $size->$listing_size_id) { ?>
                                                                        <option value="<?php echo \mvc\request\requestClass::getInstance()->getGet(listingTableClass::getNameField(listingTableClass::LISTING_SIZE_ID_LISTING_SIZE . '_to', true)); ?>" selected> SELECTED: <?php echo $size->$listing_size_description; ?></option>
                                                                      <?php } else { ?>
                                                                        <option value="<?php echo $size->$listing_size_id; ?>"><?php echo $size->$listing_size_description; ?></option>
                                                                      <?php } ?>
                                                                    <?php endforeach; ?>
                                                        ...
                                                        <div class="row ">
                                                            <div class="col-md-4 col-sm-6 col-xs-12  form-group">
                                                                <label class=""for="<?php echo rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true); ?>"> Status</label>
                                                                <select id="<?php echo rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true); ?>" name="<?php echo rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true); ?>"  class="form-control">
                                                                    <option value="">Select Option</option>
                                                                    <option value="All" <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == "All") ? 'selected' : ''; ?>> <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == "All") ? 'SELECTED: ' : ''; ?> Select All</option>
                                                                    <option value="1" <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 1) ? 'selected' : ''; ?>> <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 1) ? 'SELECTED: ' : ''; ?> Closed</option>
                                                                    <option value="2" <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 2) ? 'selected' : ''; ?>> <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 2) ? 'SELECTED: ' : ''; ?> Pending</option>  
                                                                    <option value="3" <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 3) ? 'selected' : ''; ?>> <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 3) ? 'SELECTED: ' : ''; ?> Archived</option>
                                                                    <option value="4" <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 4) ? 'selected' : ''; ?>> <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 4) ? 'SELECTED: ' : ''; ?> Landlord Rented</option>
                                                                    <option value="5" <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 5) ? 'selected' : ''; ?>> <?php echo (\mvc\request\requestClass::getInstance()->getGet(rentalDealsTableClass::getNameField(rentalDealsTableClass::STATUS, true)) == 5) ? 'SELECTED: ' : ''; ?> Not Specified</option> 
                                                                </select>
                                                        ...
                                                        <div class="row">
                                                            <div class="text-center">
                                                                <a href="<?php echo routing::getInstance()->getUrlWeb("deal", "index"); ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--dark" type="button"> Reset</a>
                                        ...
                                        <div class="panel panel-success">
                                            <div class="panel-body">
                                                <div class=" pull-right">
                                                    <a href="<?php echo routing::getInstance()->getUrlWeb("deal", "index"); ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> <b>Export</b></a>
                                                </div></br>
                                            </div>
                                        </div>
                                    ...
                                    <div id="sales_deals_panel" class="tab-pane fade">
                                        ...
                                        <table id="sales_deals_table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Address</th>
                                                    <th>Unit #</th>
                        ...
                        <script>
                          $(document).ready(function () {
                              ...
                              $('#sales_deals_table').DataTable({
                                  ...
                                  "bServerSide": true,
                                  "order": [0, 'desc'],
                                  "sAjaxSource": "ajax?sales_deals_data",
                                  "sAjaxDataProp": "data",
                                  "deferRender": true,
                                  "searching": false
                              });
                              $sales_table = $('table#sales_deals_table').DataTable();
