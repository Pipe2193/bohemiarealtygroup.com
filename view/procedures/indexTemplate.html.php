                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            ...
                            <div class=" hidden-xs x_title">
                                <h2><i class="fa fa-server" aria-hidden="true"></i> Add Procedures For <?php echo landlordTableClass::getLandlordName(\mvc\request\requestClass::getInstance()->getGet(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true))) ?></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="page-title-bohemia visible-xs">
                                    <h4 class="text-center"><i class="fa fa-server" aria-hidden="true"></i> Add Procedures </br> For <?php echo landlordTableClass::getLandlordName(\mvc\request\requestClass::getInstance()->getGet(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true))) ?></h4>
                                </div>
                                        ...
                                        <form id="editProcedures" class="form-horizontal form-label-left input_mask" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb("procedures", "create", array(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true) => mvc\request\requestClass::getInstance()->getGet(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true)))); ?>">
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    ...
                                                    <button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary"><i class="fa fa-plus-square" aria-hidden="true"></i> Create Procedures</button>
                                                </div>
                                            </div>
                                        </form>
                                        <script>
