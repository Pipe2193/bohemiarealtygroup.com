...
<div id="neighborhood">
    <div class="hero cell">
        <img src="<?php echo routing::getInstance()->getUrlImg('neighborhood/upper_west_side.jpg') ?>" alt="Upper West Side" title="Upper West Side" style="height: 800px;">
    ...
    <div class="grid-container">
        <div class="row">
            ...
            <div id="address" class="small-12 mlarge-8 columns">
                <h3>Neighborhood</h3>
                <p> The Upper West Side is bound by 59th St to the south, Central Park to the west, the Hudson River to the west, and 96th St and 110th St to the north. </p></br>
                <div class="row">
