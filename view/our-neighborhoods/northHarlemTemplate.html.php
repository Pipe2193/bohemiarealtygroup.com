...
<div id="neighborhood">
    <div class="hero cell">
        <img src="<?php echo routing::getInstance()->getUrlImg('neighborhood/harlem.jpg') ?>" alt="Harlem" title="Harlem" style="height: 800px;">
        <div class="grid-container">
            <div class="column row">
                <h2>North Harlem - <small>Above 125th Street</small></h2>
            </div>
        </div>
    </div>
    <div class="grid-container">
        <div class="row">
            ...
            <div id="address" class="small-12 mlarge-8 columns">
                <h3>Neighborhood</h3>
                <p>North Harlem is boarded on the south by 125th street, on the north by 145th street, on the west by Amsterdam Ave and on the east by 5th Ave.</p>
                <div class="row">
    ...
    <div name="map" id="map" class="map cell">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24156.467451700337!2d-73.96564103761301!3d40.8156961992457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2f66e2188a29f%3A0xb408afef09e2702e!2sHarlem%2C+New+York%2C+NY!5e0!3m2!1sen!2sus!4v1521442985621" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>
    <div class="grid-container">
