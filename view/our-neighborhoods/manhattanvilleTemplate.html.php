...
<div id="neighborhood">
    <div class="hero cell">
        <img src="<?php echo routing::getInstance()->getUrlImg('neighborhood/manhattan_valley.jpg') ?>" alt="Manhattan Valley" title="Manhattan Valley" style="height: 800px;">
        <div class="grid-container">
            <div class="column row">
                <h2>Manahattanville</h2>
            </div>
        </div>
    </div>
    <div class="grid-container">
        <div class="row">
            ...
            <div id="address" class="small-12 mlarge-8 columns">
                <h3>Neighborhood</h3>
                <p> Formerly known as the Bloomingdale District, Manhattan Valley is bounded by 110th St to the north, 96th St to the south, Central Park West to the east, and Broadway to the west. </p></br>
                <div class="row">
    ...
    <div name="map" id="map" class="map cell">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14363.654052108814!2d-73.95326334064465!3d40.81508389825615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2f66970a33c79%3A0x73c32d69ed4ff1c2!2sManhattanville%2C+New+York%2C+NY+10027!5e0!3m2!1sen!2sus!4v1521577764848" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>
    <div class="grid-container">
        <div name="what-to-do" id="what-to-do" class="column row">
            <hr>
            <h3>What to do</h3>
            <p>Though most are primarily restaurants, after dinner a lot of these eateries become places to drink up and cut a mean rug. La Casa Del Mofongo, Altus Café, and Apt.78 all keep their bars open into the night and introduce DJs, transforming themselves into dance central! Locksmith and Buddha Beer keep the taps flowing and your glasses full...</p>
            <div class="row">
