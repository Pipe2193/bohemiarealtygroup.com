                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            <div class=" hidden-xs x_title">
                                <h2><i class="fa fa-server" aria-hidden="true"></i> Manage Listing <?php echo strtoupper(buildingTableClass::getBuildingAddress(buildingTableClass::getBuildingHash($objListing[0]->$listing_building_id))) . ', UNIT: ' . $objListing[0]->$listing_unit_number; ?></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="page-title-bohemia visible-xs">
                                    <h4 class="text-center"><i class="fa fa-server" aria-hidden="true"></i> Manage Listing </br><?php echo strtoupper(buildingTableClass::getBuildingAddress(buildingTableClass::getBuildingHash($objListing[0]->$listing_building_id))) . ', UNIT: ' . $objListing[0]->$listing_unit_number; ?></h4>
                                </div>
                                                      ...
                                                      <div class="panel-body">
                                                          <div class="row">
                                                              <div class="btn-group  btn-group-sm pull-right">
                                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <?php if (listingAssignmentTableClass::isListingAssigned($listing->$listing_id, session::getInstance()->getUserId()) == 0) { ?>
                                                                        <button data-hash="<?php echo $listing->$listing_hash; ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect btnAssign_listing" type="button"> Assign</button>
                                                                        <?php
                                                                      } else {
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <table id="listing_ads" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <div class="alert alert-info alert-dismissible" role = "alert">
                                                          <p class = "text-center">
                                                              <b> <i class = "fa fa-info-circle" aria-hidden = "true"></i> Information: There are no Listing Ads found. </b><a href="<?php echo routing::getInstance()->getUrlWeb('listing', 'account') ?>" class = "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--dark" type = "button"> My Listings</a><br>
                                                          </p>
                                                      </div>
                                                      <?php
                                                    } else {
                                ...
                                <script>
                                  $(document).ready(function () {
                                      $(".btnAssign_listing").on('click', function () {
                                      ...
                                      $(".btnUnassign_listing").on('click', function () {
