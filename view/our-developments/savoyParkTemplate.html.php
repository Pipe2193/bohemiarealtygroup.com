...
<div class="hero cell">
    <img src="../assets/img/the-leo.jpg" alt="The Leo" title="The Leo">
...
<div class="development grid-container">
    <div class="row">
        <div class="small-12 mlarge-6 columns">
            <ul>
                <li><img src="../assets/img/the-leo.jpg" alt="The Leo" title="The Leo"></li>
                <li><img src="../assets/img/the-leo.jpg" alt="The Leo" title="The Leo"></li>
                <li><img src="../assets/img/the-leo.jpg" alt="The Leo" title="The Leo"></li>
            </ul>
        </div>
    ...
    <div class="column row">
        <h1>Contact The Savoy Park sales team for more information:</h1>
    </div>
    <div class="row">
        <div class="small-12 mlarge-2 columns">
        </div>
        <div class="agent small-12 mlarge-4 columns">
            <img src="../assets/img/beth-gittleman.jpg">
        ...
        <div class="agent small-12 mlarge-4 columns">
            <img src="../assets/img/susan-molloy.jpg">
            <h2>Susan Molloy</h2>
