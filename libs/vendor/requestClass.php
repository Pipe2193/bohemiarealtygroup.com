  ...
  class requestClass implements requestInterface {
    ...
    public static function getInstance() {
      if (!isset(self::$instance)) {
        self::$instance = new self(\filter_input_array(\INPUT_POST), \filter_input_array(\INPUT_GET), $_REQUEST, \filter_input_array(\INPUT_COOKIE), $_FILES, $_SERVER, \filter_input_array(\INPUT_ENV));
      }
