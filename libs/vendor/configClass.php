...
namespace mvc\config {
  ...
  class configClass {
    ...
    private static $default_module_exception;
    private static $default_action_exception;
    private static $soho_app_name;
    private static $soho_accron_name;
    private static $soho_framework_version;

    public static function getDefaultModuleException() {
      return self::$default_module_exception;
    }

    public static function getDefaultActionException() {
      return self::$default_action_exception;
    }

    public static function setDefaultModuleException($default_module_exception) {
      self::$default_module_exception = $default_module_exception;
    }

    public static function setDefaultActionException($default_action_exception) {
      self::$default_action_exception = $default_action_exception;
    }

    public static function getSohoFrameworkVersion() {
      return self::$soho_framework_version;
    }

    public static function getSohoFrameworkAppName() {
      return self::$soho_app_name;
    }

    public static function getSohoFrameworkAccronName() {
      return self::$soho_accron_name;
    }
    ...
    /**
     * soho framework Application name
     * @param type $soho_framework_version
     */
    public static function setSohoFrameworkVersion($soho_framework_version) {
      self::$soho_framework_version = $soho_framework_version;
    }

    /**
     * soho framework Application name
     * @param type $soho_app_name
     */
    public static function setSohoFrameworkAppName($soho_app_name) {
      self::$soho_app_name = $soho_app_name;
    }

    /**
     * soho framework Accron name
     * @param type  private static
     */
    public static function setSohoFrameworAccronName($soho_accron_name) {
      self::$soho_accron_name = $soho_accron_name;
    }
