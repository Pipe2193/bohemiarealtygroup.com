  ...
  public function execute() {
    ...
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        if (request::getInstance()->hasPost("add_listing")) {
          $addListing = request::getInstance()->getPost("add_listing");
          ?>
          ...
          <div class="panel panel-bohemia">
              ...
              <div class="panel-body">
                  ...
                  <form id="addListing" class="form-horizontal form-label-left input_mask" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb("brgdm", "create"); ?>">
