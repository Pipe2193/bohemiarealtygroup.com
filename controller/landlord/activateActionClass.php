      ...
      if (request::getInstance()->isMethod('GET')) {
        ...
        if (request::getInstance()->hasGet(landlordTableClass::getNameField(landlordTableClass::LANDLORD_HASH, true))) {
          ...
          if ($landlord_id != false) {
            ...
            if (landlordTableClass::isActivated($landlord_id->id_landlord) != 1) {
              ...
              session::getInstance()->setSuccess("<b> The Landlord $landlord_name </b> has been successfully Activated.");
              routing::getInstance()->redirect("landlord", "index");
            } else {
              session::getInstance()->setInformation("This Landlord has been Already Activated. No Update Required. ");
              routing::getInstance()->redirect('landlord', 'index');
            }
          } else {
