...
/**
 * Description of feedActionClass
 *
 * @author Andres Felipe Alvarez L <andresf9321@gmail.com>
 */
class feedActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    ...
    try {
      ...
      $objEvents = eventTableClass::getAll($fields_events, true, $order_by_events, 'DESC');



      $this->defineView('feed', 'hiring', session::getInstance()->getFormatOutput());
