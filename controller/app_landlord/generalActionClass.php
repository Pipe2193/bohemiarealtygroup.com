 ...
 */
class generalActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    ...
    try {
      ...
      $where_procedures = array(
          proceduresTableClass::LANDLORD_ID_LANDLORD =>  $landlord_general_id
      );
      ...
      $where_files = array(
          fileTableClass::LANDLORD_ID_LANDLORD => $landlord_general_id
      );
      $this->objFiles = fileTableClass::getAll($files_fields, true, null, null, null, null, $where_files);
      $this->defineView('general', 'app_landlord', session::getInstance()->getFormatOutput());
